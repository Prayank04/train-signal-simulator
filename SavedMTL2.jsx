...
const {
  ...
  // Use mainline length as fallback design width
  const designWidth = TRACK_LAYOUT_CONSTANTS.designWidth ?? (mainlineEnd - mainlineStart);
  ...
  return (
    <div className="main-track-layout">
      <svg
        ...
        width="100%"
        height="400"
        // Use fixed design coordinate system for viewBox
        viewBox={`0 0 ${designWidth} 400`}
      ...
      >
        ...
        <text x={mainDims.dnLoopLineStart - 88} y={dnLoopLineY - 2} fill="yellow" fontSize="9" fontFamily="Arial">MACHINE SIDING</text>
        <text x={mainDims.dnLoopLineStart - 64} y={dnLoopLineY + 8} fill="yellow" fontSize="9" fontFamily="Arial">(CSR 120m)</text>

        {/* Extra track line at DNloopLineStart */}
        <line x1={mainDims.dnLoopLineStart} y1={dnLoopLineY} x2={sections.dnLoop[0].x} y2={dnLoopLineY} stroke="white" strokeWidth="3" />
        
        {/* 1. SW2 and its circle */}
        <Circle
          sections={sections.dnLoop}
          CircleName="SW2"
          lineY={dnLoopLineY}
          TextOutside="SW2"
          x1={mainDims.mainlineStart}
        ...
        <ShuntUp startX={sections.dnLoop[0].x - (0.1) * (sections.dnLoop[1].x- sections.dnLoop[0].x)} label="SH196" lineY={dnLoopLineY -3} />
        ...
        <ShuntDown startX={sections.dnLoop[1].x - (0.065) * (sections.dnLoop[2].x- sections.dnLoop[1].x)} label="SH193" lineY={dnLoopLineY} />
        ...
        <DnLoopLineSignal startX={sections.dnLoop[2].x + (0.15) * (mainDims.dnLoopLineEnd- sections.dnLoop[2].x)} label="S44,SH144" lineY={dnLoopLineY} initialColor="R" signalName="S44" />
        
        
        
        {/* 13. 120M OVERRUN LINE (at end of line) */}
        <text x={mainDims.dnLoopLineEnd + 12.5} y={dnLoopLineY - 2} fill="yellow" fontSize="9" fontFamily="Arial">120M OVERRUN LINE</text>
        <text x={mainDims.dnLoopLineEnd + 12.5} y={dnLoopLineY + 8} fill="yellow" fontSize="9" fontFamily="Arial">(NOT FOR STABLING)</text>
        ...
        <S98C98Signal startX={sections.dn[0].x + (0.50)* (sections.dn[1].x - sections.dn[0].x)} label="S98/C98" lineY={dnMainLineY} initialColor="R" signalName="S98" />
        ...
        {/* 11. S42 signal */}
        <DnMainLineSignalType2 startX={sections.dn[4].x + (0.25)* (sections.dn[5].x - sections.dn[4].x)} label="S42/SH142" lineY={dnMainLineY} initialColor="R" signalName="S42" />
        ...
        <ShuntDown startX={sections.dn[4].x + (0.9)* (sections.dn[5].x - sections.dn[4].x)} label="SH143" lineY={dnMainLineY} />
        ...
        {/* 16. S4/SH104 signal */}
        <DnMainLineSignalType2 startX={sections.dn[5].x + (1.15)* (sections.dn[6].x - sections.dn[5].x)} label="S4/SH104" lineY={dnMainLineY} initialColor="R" signalName="S4" />
        ...
        <S2Signal startX={sections.dn[8].x - (0.2)* (sections.dn[9].x - sections.dn[8].x)} label="S2" lineY={dnMainLineY} initialColor="R" signalName="S2" />
        ...
        <A3114Signal startX={sections.dn[10].x - (0.35)* (mainDims.mainlineEnd - sections.dn[10].x)} label="A3114" lineY={dnMainLineY} initialColor="G" signalName="A3114" />
        ...
        {/* 2. A3101 Signal */}
        <A3101Signal startX={sections.up[10].x - (0.7)* (mainDims.mainlineEnd - sections.up[10].x)} label="A3101" lineY={upMainLineY} initialColor="Y" signalName="A3101" />
        ...
        {/* 4. S1/C1 Signal */}
        <S1C1Signal startX={sections.up[7].x + (0.55)* (sections.up[8].x- sections.up[7].x)} label="S1/C1" lineY={upMainLineY} initialColor="R" signalName="S1" />

        
        {/* Signal on vertical line after UW */}
        <VerticalLineSignalWithCross startX={sections.up[7].x - (0.000001)* (sections.up[8].x- sections.up[7].x)} lineY={upMainLineY + 24.5} />
        ...
        <VerticalLineSignal startX={sections.up[5].x - (0.11)* (sections.up[6].x- sections.up[5].x)} lineY={upMainLineY} />
        ...
        {/* 12. S41/SH141 Signal */}
        <UpMainLineSignalType2 startX={sections.up[3].x + (0.6)* (sections.up[4].x- sections.up[3].x)} label="S41/SH141" lineY={upMainLineY} initialColor="R" signalName="S41" />
        ...
        <ShuntUp startX={sections.up[3].x  - (0.1)* (sections.up[4].x- sections.up[3].x)} label="SH140" lineY={upMainLineY - 3} />
        ...
        {/* 23. S97/SH197 Signal */}
        <UpMainLineSignalType2 startX={sections.up[1].x + (0.53)* (sections.up[2].x- sections.up[1].x)} label="S97/SH197" lineY={upMainLineY} initialColor="R" signalName="S97" />
        
        {/* 24. S99 Signal */}
        <S99Signal startX={sections.up[0].x - (0.35)* (sections.up[1].x- sections.up[0].x)} label="S99" lineY={upMainLineY} initialColor="R" signalName="S99" />
      ...
      {/* 25. UZ (leftmost) */}
        ...
        <text x={mainDims.upLoopLineEnd + 11.61} y={upLoopLineY - 2} fill="yellow" fontSize="9" fontFamily="Arial">MACHINE SIDING</text>
        <text x={mainDims.upLoopLineEnd + 11.61} y={upLoopLineY + 9} fill="yellow" fontSize="9" fontFamily="Arial">(CSR 120m)</text>

        {/* Extra track line at DNloopLineStart */}
        <line x1={mainDims.upLoopLineEnd} y1={upLoopLineY} x2={sections.upLoop[3].x} y2={upLoopLineY} stroke="white" strokeWidth="3" />
        
        {/* 2. SE1 */}
        <Circle
          sections={sections.upLoop}
          CircleName="SE1"
          lineY={upLoopLineY}
          TextOutside="SE1"
          x1={3}
        ...
        <ShuntDown startX={sections.upLoop[2].x + (0.92)* (sections.upLoop[3].x- sections.upLoop[2].x)} label="SH123" lineY={upLoopLineY} />
        ...
        <ShuntUp startX={sections.upLoop[1].x + (0.9)* (sections.upLoop[2].x- sections.upLoop[1].x)} label="SH124" lineY={upLoopLineY} />
        ...
        <UpLoopLineSignal startX={sections.upLoop[1].x - (0.22)* (sections.upLoop[2].x- sections.upLoop[1].x)} label="S39/SH139" lineY={upLoopLineY} initialColor="R" signalName="S39" />
        ...
        <text x={mainDims.upLoopLineStart - 110} y={upLoopLineY - 2} fill="yellow" fontSize="9" fontFamily="Arial">120M OVERRUN LINE</text>
        <text x={mainDims.upLoopLineStart - 110} y={upLoopLineY + 8} fill="yellow" fontSize="9" fontFamily="Arial">(NOT FOR STABLING)</text>
        ...
        <SlantingLine 
          Upx={sections.up[3].x + (2.5/10) * (sections.up[4].x - sections.up[3].x)} 
          Upy={upMainLineY} 
          Dnx={mainDims.upLoopLineStart + (6/10) * (sections.upLoop[0].x - mainDims.upLoopLineStart)} 
          Dny={upLoopLineY} 
          UpName="249B" 
          DnName="249A" 
        />
        ...
        <SlantingLine 
          Upx={sections.up[5].x + (6/10) * (sections.up[6].x - sections.up[5].x)} 
          Upy={upMainLineY} 
          Dnx={sections.upLoop[2].x + (4/11) * (sections.upLoop[3].x - sections.upLoop[2].x)} 
          Dny={upLoopLineY} 
          UpName="203B" 
          DnName="203A" 
        />
        ...
        <SlantingLine 
          Upx={sections.dn[1].x + (8.5/10) * (sections.dn[2].x - sections.dn[1].x)} 
          Upy={dnMainLineY} 
          Dnx={sections.up[1].x + (4/10) * (sections.up[2].x - sections.up[1].x)} 
          Dny={upMainLineY} 
          UpName="298B" 
          DnName="298A" 
        />
        ...
        <SlantingLine 
          Upx={sections.dn[6].x + (7/10) * (sections.dn[7].x - sections.dn[6].x)} 
          Upy={dnMainLineY} 
          Dnx={sections.up[6].x + (1.5/10) * (sections.up[7].x - sections.up[6].x)} 
          Dny={upMainLineY} 
          UpName="202A" 
          DnName="202B" 
        />
        ...
        <SlantingLine 
          Upx={sections.dnLoop[0].x + (8/10) * (sections.dnLoop[1].x - sections.dnLoop[0].x)} 
          Upy={dnLoopLineY} 
          Dnx={sections.dn[2].x + (4.5/10) * (sections.dn[3].x - sections.dn[2].x)} 
          Dny={dnMainLineY} 
          UpName="296A" 
          DnName="296B"
        />
        ...
        <SlantingLine 
          Upx={sections.dnLoop[2].x + (5/10) * (mainDims.dnLoopLineEnd - sections.dnLoop[2].x)} 
          Upy={dnLoopLineY} 
          Dnx={sections.dn[4].x + (6.5/10) * (sections.dn[5].x - sections.dn[4].x)} 
          Dny={dnMainLineY} 
          UpName="242A" 
          DnName="242B" 
        />
