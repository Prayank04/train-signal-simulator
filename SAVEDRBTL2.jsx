    ...
    >
      <svg width="220" height="180" style={{ backgroundColor: "#333333" }}>
        ...
        */}
        ...
        <VerticalSections
          sections={RIGHT_BOTTOM_LINE1_SECTIONS.map(s => ({
                    ...s,
                    x: s.x - rightbot_lineStart,
                  }))}
        ...
        <VerticalSections
          sections={RIGHT_BOTTOM_LINE2_SECTIONS.map(s => ({
                    ...s,
                    x: s.x - rightbot_lineStart,
                  }))}
        ...
        <VerticalSections
          sections={RIGHT_BOTTOM_LINE3_SECTIONS.map(s => ({
                    ...s,
                    x: s.x - rightbot_lineStart,
                  }))}
        ...
        <VerticalSections
          sections={RIGHT_BOTTOM_LINE4_SECTIONS.map(s => ({
                    ...s,
                    x: s.x - rightbot_lineStart,
                  }))}
